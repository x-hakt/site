  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        kind: 'choice',
        id: 'setpieces',
        label: 'Set-piece lines you deliberately deploy: idioms, quotes, a running bit',
        multi: true,
        other: true,
        options: [
          'none, borrowed lines read as borrowed',
          'idioms and old turns of phrase',
          'film, book or song quotes',
          'a persona or running bit (mock-formal, pirate, noir, sportscaster…)',
      ...
      },
      {
        kind: 'text',
        id: 'setpieces-which',
        label: 'If any: the ones you actually reach for, and how often.',
        hint: 'e.g. “disinclined to acquiesce”, “that dog won’t hunt”, a specific quote. A splash, or all through it?',
        rows: 2,
      },
    ],
  },
